...
<html lang="en">
  ...
  <body>
    ...
    <section
      class="text-white py-5 p-lg-50 text-center"
      style="
        height: 600px;
        background:
      ...
      <div class="container mb-3">
        <div class="row">
          ...
          <div class="col-md">
            ...
            >
              <div
                class="card-body text-center bg-dark text-white"
                style="border: 0px"
              >
                <span class="fs-5">3</span>
                <hr class="my-0" />
                Видео-лекции теории практики
              </div>
            </div>
          </div>
          <div class="col-md">
            ...
            >
              <div class="card-body text-center bg-dark text-white">
                ...
                <hr class="my-0" />
                Месяцев обратной связи учеников*
              </div>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container">
        <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
          <h1 class="display-4 fw-normal">Стоимость пакетов услуг</h1>
                            ...
                            <div class="row mt-2">
                              ...
                              <div class="col-11">
                                <label
                                  ...
                                  оказания услуг (договор - оферта) ознакомлен.
                                  С правилами оказания услуг согласен»
                                </label>
